...
@Database(entities = {Tarefa.class, Meta.class, Checklist.class, ChecklistItem.class, Anotacao.class, Flashcard.class, Materia.class, AtividadeLog.class}, version = 18, exportSchema = false)
public abstract class AppDatabase extends RoomDatabase {
    ...
    // Gerencia os comandos dos Flashcards
